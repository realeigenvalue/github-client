...
/**
 * Async task to un-star a repository, with authentication
 */
public class UnstarRepository extends AsyncTask<Void, Void, Void> {
    private String user;
    ...
    public UnstarRepository(String user, String repository, String credential, String URL, ArrayList<Repository> starred) {
        this.user = user;
