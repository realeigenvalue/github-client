...
/**
 * Async task to follow a user, with authentication
 */
public class FollowUser extends AsyncTask<Void, Void, Void> {
    private String user;
    private String credential;
    private String URL;
    private ArrayList<User> following;

    public FollowUser(String user, String credential, String URL, ArrayList<User> following) {
        this.user = user;
    ...
    protected Void doInBackground(Void... params) {
        try {
            URL url = new URL(this.URL + "/" + this.user);
